...
public class PluginProcessManager {
    ...
    private static Object sGetCurrentProcessNameLock = new Object();//？持有当前进程锁的对象？
    private static Map<String, ClassLoader> sPluginClassLoaderCache = new WeakHashMap<String, ClassLoader>(1);//ClassLoard缓存
    ...
    private static void initProcessList(Context context) {
        try {
            ...
            //遍历包中的receiver 如果其所在进程没有被记录，则添加进程到进程队列
            ...
            //遍历包中的provider 如果其所在进程没有被记录，则添加进程到进程队列
            ...
            //遍历包中的service 如果其所在进程没有被记录，则添加进程到进程队列
            ...
            //遍历包中的activitie 如果其所在进程没有被记录，则添加进程到进程队列
